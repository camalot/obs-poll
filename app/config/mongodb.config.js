...
let result = {
	mongodb: {
		HOST: process.env.CP_MONGODB_HOST || "localhost",
		PORT: parseInt(process.env.CP_MONGODB_PORT || "27017", 0),
		USERNAME: process.env.CP_MONGODB_USERNAME || "mdbroot",
		PASSWORD: process.env.CP_MONGODB_PASSWORD || "mdbroot",
		AUTHDB: process.env.CP_MONGODB_AUTHDB || "admin",
		CONNECT_ARGS: process.env.CP_MONGODB_ARGS || "",
		DATABASE: process.env.CP_MONGODB_DATABASE || "obs-poll"
	}
};
